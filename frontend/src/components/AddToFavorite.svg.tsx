const AddToFavoriteSVG = ({
  ...
  return (
    <svg
      ...
      width="64" // Largeur 64px
      height="64" // Hauteur 64px
      viewBox="0 0 24 24" // Définit la vue de l'image SVG en maintenant les proportions
...
export default AddToFavoriteSVG;
